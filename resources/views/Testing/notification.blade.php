...
<body>
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown dropdown-notifications">
                    <a href="#notifications-panel" class="dropdown-toggle" data-toggle="dropdown">
                        <i data-count="0" class="glyphicon glyphicon-bell notification-icon"> </i>View All
                    </a>

                    <div class="dropdown-container">
                        <div class="dropdown-toolbar">
                            <div class="dropdown-toolbar-actions">
                                <button type="button" id="clear_notifications_button" style="margin-left: 300px; color:red; background: none; border: none;">
                                    Clear All
        ...
        <div class="row mt-5">
            ...
            <span class="btn btn-danger my-3">
                ...
                <div class="input-group">
                    ...
                    <input type="hidden" name="message" id="message" value="{{$products->id}}">
    ...
    <script>
        ...
        // var pusher = new Pusher('07610ef0513f26d7379f', {
        //     cluster: 'eu'
        // });
        ...
        //     // app.messages.push(data.message); // Access the 'message' property
        //     console.log(data)
        // });
    </script>
